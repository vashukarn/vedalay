                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <td>
                                <div class="btn-group">
                                  @can('feepayment-edit')
                                  <a href="{{route('feepayment.edit',$value->id)}}" title="Edit feepayment" class="btn btn-success btn-sm btn-flat"><i class="fas fa-edit"></i></a>
                                  @endcan
                                  @can('feepayment-delete')
                                  {{Form::open(['method' => 'DELETE','route' => ['feepayment.destroy', $value->id],'style'=>'display:inline','onsubmit'=>'return confirm("Are you sure you want to delete this feepayment?")']) }}
                                  {{Form::button('<i class="fas fa-trash-alt"></i>',['class'=>'btn btn-danger btn-sm btn-flat','type'=>'submit','title'=>'Delete feepayment '])}}
                                  {{ Form::close() }}
                                  @endcan
                              </div>
                              </td>
