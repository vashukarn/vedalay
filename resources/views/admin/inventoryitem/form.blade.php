                    ...
                    <div class="row">
                        <div class="col-sm-10 offset-lg-1">
                            <div class="form-group row {{ $errors->has('title') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('title', @$inventoryitem_info->title, ['class' => 'form-control', 'id' => 'title', 'placeholder' => 'Inventory Item Title', 'style' => 'width:80%']) }}
                                    @error('title')
                            ...
                            <div class="form-group row {{ $errors->has('image') ? 'has-error' : '' }}">
                                {{ Form::label('image', 'Item Image:*', ['class' => 'col-sm-3']) }}
                                <div class="col-sm-6">
