        ...
        <div class="card card-primary card-outline card-tabs">
            <div class="card-header p-0 pt-1 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-three-blog-tab" data-toggle="pill"
                            href="#custom-tabs-three-blog" role="tab" aria-controls="custom-tabs-three-blog"
                            aria-selected="false">Blog</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-three-parallax-tab" data-toggle="pill"
                            href="#custom-tabs-three-parallax" role="tab" aria-controls="custom-tabs-three-parallax"
                            aria-selected="false">Parallax</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content" id="custom-tabs-three-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="custom-tabs-three-landing" role="tabpanel"
                        ...
                        <div class="form-group row {{ $errors->has('landing_title1') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                {{ Form::text('landing_title1', @$homepage_info->landing_title1, ['placeholder' => 'Enter First Partial Title', 'class' => 'form-control', 'id' => 'landing_title1', 'style' => 'width:80%']) }}
                        ...
                        <div class="form-group row {{ $errors->has('landing_title2') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                {{ Form::text('landing_title2', @$homepage_info->landing_title2, ['placeholder' => 'Enter Middle Different Color Title', 'class' => 'form-control', 'id' => 'landing_title2', 'style' => 'width:80%']) }}
                        ...
                        <div class="form-group row {{ $errors->has('landing_title3') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                {{ Form::text('landing_title3', @$homepage_info->landing_title3, ['placeholder' => 'Enter Second Partial Title', 'class' => 'form-control', 'id' => 'landing_title3', 'style' => 'width:80%']) }}
                        ...
                        <div class="form-group row {{ $errors->has('landing_subtitle') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                {{ Form::text('landing_subtitle', @$homepage_info->landing_subtitle, ['placeholder' => 'Enter Subtitle', 'class' => 'form-control', 'id' => 'landing_subtitle', 'style' => 'width:80%']) }}
                        ...
                        <div class="form-group row {{ $errors->has('landing_image') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-6">
                                ...
                                @if (isset($homepage_info->landing_image))
                                    Old landing image: &nbsp; <img src="{{ @$homepage_info->landing_image }}"
                    ...
                    <div class="tab-pane fade" id="custom-tabs-three-customer" role="tabpanel"
                        ...
                        <div class="form-group row {{ $errors->has('customers_title1') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                {{ Form::text('customers_title1', @$homepage_info->customers_title1, ['placeholder' => 'Enter First Partial Title', 'class' => 'form-control', 'id' => 'customers_title1', 'style' => 'width:80%']) }}
                        ...
                        <div class="form-group row {{ $errors->has('customers_title2') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                {{ Form::text('customers_title2', @$homepage_info->customers_title2, ['placeholder' => 'Enter Middle Different Color Title', 'class' => 'form-control', 'id' => 'customers_title2', 'style' => 'width:80%']) }}
                        ...
                        <div class="form-group row {{ $errors->has('customers_title3') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                {{ Form::text('customers_title3', @$homepage_info->customers_title3, ['placeholder' => 'Enter Second Partial Title', 'class' => 'form-control', 'id' => 'customers_title3', 'style' => 'width:80%']) }}
                        ...
                        <div class="form-group row {{ $errors->has('customers_subtitle') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                {{ Form::text('customers_subtitle', @$homepage_info->customers_subtitle, ['placeholder' => 'Enter Subtitle', 'class' => 'form-control', 'id' => 'customers_subtitle', 'style' => 'width:80%']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <span class="input-group-btn">
                                        <a id="lfm1" data-input="customers_logo1" data-preview="holder"
                                            class="btn btn-primary text-white">
                                            <i class="fa fa-picture-o"></i> Choose
                                        </a>
                                    </span>
                                ...
                                @if (isset($homepage_info->customers_logo1))
                                    Old logo: &nbsp; <img src="{{ @$homepage_info->customers_logo1 }}"
                                        alt="Image Not Available" class="img img-thumbail mt-2" style="width: 100px">
                                @endif
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <span class="input-group-btn">
                                        <a id="lfm2" data-input="customers_logo2" data-preview="holder"
                                            class="btn btn-primary text-white">
                                            <i class="fa fa-picture-o"></i> Choose
                                        </a>
                                    </span>
                                ...
                                @if (isset($homepage_info->customers_logo2))
                                    Old logo: &nbsp; <img src="{{ @$homepage_info->customers_logo2 }}"
                                        alt="Image Not Available" class="img img-thumbail mt-2" style="width: 100px">
                                @endif
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <span class="input-group-btn">
                                        <a id="lfm3" data-input="customers_logo3" data-preview="holder"
                                            class="btn btn-primary text-white">
                                            <i class="fa fa-picture-o"></i> Choose
                                        </a>
                                    </span>
                                ...
                                @if (isset($homepage_info->customers_logo3))
                                    Old logo: &nbsp; <img src="{{ @$homepage_info->customers_logo3 }}"
                                        alt="Image Not Available" class="img img-thumbail mt-2" style="width: 100px">
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="custom-tabs-three-whyus" role="tabpanel"
                        ...
                        <div class="form-group row {{ $errors->has('whyus_title') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                {{ Form::text('whyus_title', @$homepage_info->whyus_title, ['placeholder' => 'Enter Title', 'class' => 'form-control', 'id' => 'whyus_title', 'style' => 'width:80%']) }}
                                @error('whyus_title')
                                    <span class="help-block error">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row {{ $errors->has('whyus_subtitle') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                {{ Form::text('whyus_subtitle', @$homepage_info->whyus_subtitle, ['placeholder' => 'Enter Subtitle', 'class' => 'form-control', 'id' => 'whyus_subtitle', 'style' => 'width:80%']) }}
                        ...
                        <div class="form-group row {{ $errors->has('whyus_paragraph') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                {{ Form::text('whyus_paragraph', @$homepage_info->whyus_paragraph, ['placeholder' => 'Enter Paragraph', 'class' => 'form-control', 'id' => 'whyus_paragraph', 'style' => 'width:80%']) }}
                        ...
                        <div class="form-group row {{ $errors->has('whyus_image') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-btn">
                                        <a id="lfm4" data-input="whyus_image" data-preview="holder"
                                            class="btn btn-primary text-white">
                                            <i class="fa fa-picture-o"></i> Choose
                                        </a>
                                    </span>
                                ...
                                @if (isset($homepage_info->whyus_image))
                                    Old why us image: &nbsp; <img src="{{ @$homepage_info->whyus_image }}"
                                        alt="Image Not Available" class="img img-thumbail mt-2" style="width: 100px">
                                @endif
                                @error('whyus_image')
                                    <span class="help-block error">{{ $message }}</span>
                        ...
                        <div class="form-group row {{ $errors->has('whyus_link') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                {{ Form::text('whyus_link', @$homepage_info->whyus_link, ['placeholder' => 'Enter Paragraph', 'class' => 'form-control', 'id' => 'whyus_link', 'style' => 'width:80%']) }}
                                @error('whyus_link')
                                    <span class="help-block error">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        @for ($i = 1; $i < 4; $i++)
                            <div class="form-group row">
                                ...
                                {{ Form::text('whyus_features[' . $i . '][title]', @$homepage_info->whyus_features[$i]['title'], ['placeholder' => 'Enter Title ' . $i, 'class' => 'col-sm-3 form-control', 'id' => 'whyus_features[' . $i . '][title]', 'style' => 'width:80%']) }}
                                {{ Form::label('whyus_features[' . $i . '][subtitle]', 'Features Subtitle ' . $i . ' :', ['class' => 'ml-4 col-sm-2']) }}
                                {{ Form::text('whyus_features[' . $i . '][subtitle]', @$homepage_info->whyus_features[$i]['subtitle'], ['placeholder' => 'Enter Subtitle ' . $i, 'class' => 'col-sm-3 form-control', 'id' => 'whyus_features[' . $i . '][subtitle]', 'style' => 'width:80%']) }}
                            </div>
                        @endfor
                    ...
                    <div class="tab-pane fade" id="custom-tabs-three-features" role="tabpanel"
                        ...
                        <div class="form-group row {{ $errors->has('features_title') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                {{ Form::text('features_title', @$homepage_info->features_title, ['placeholder' => 'Enter Features Title', 'class' => 'form-control', 'id' => 'features_title', 'style' => 'width:80%']) }}
                        ...
                        <div class="form-group row {{ $errors->has('features_subtitle') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                {{ Form::text('features_subtitle', @$homepage_info->features_subtitle, ['placeholder' => 'Enter Features Subtitle', 'class' => 'form-control', 'id' => 'features_subtitle', 'style' => 'width:80%']) }}
                        ...
                        <div class="form-group row {{ $errors->has('features_image') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-btn">
                                        <a id="lfm5" data-input="features_image" data-preview="holder"
                                            class="btn btn-primary text-white">
                                            <i class="fa fa-picture-o"></i> Choose
                                        </a>
                                    </span>
                                ...
                                @if (isset($homepage_info->features_image))
                                    Old feature image: &nbsp; <img src="{{ @$homepage_info->features_image }}"
                                        alt="Image Not Available" class="img img-thumbail mt-2" style="width: 100px">
                                @endif
                    ...
                    <div class="tab-pane fade" id="custom-tabs-three-newsletter" role="tabpanel"
                        ...
                        <div class="page-description-div">
                            ...
                            <div class="form-group row {{ $errors->has('newsletter_title') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('newsletter_title', @$homepage_info->newsletter_title, ['placeholder' => 'Enter Title', 'class' => 'form-control', 'id' => 'newsletter_title', 'style' => 'width:80%']) }}
                            ...
                            <div class="form-group row {{ $errors->has('newsletter_subtitle') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('newsletter_subtitle', @$homepage_info->newsletter_subtitle, ['placeholder' => 'Enter Subtitle', 'class' => 'form-control', 'id' => 'newsletter_subtitle', 'style' => 'width:80%']) }}
                            ...
                            <div class="form-group row {{ $errors->has('newsletter_image') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <span class="input-group-btn">
                                            <a id="lfm6" data-input="newsletter_image" data-preview="holder"
                                                class="btn btn-primary text-white">
                                                <i class="fa fa-picture-o"></i> Choose
                                            </a>
                                        </span>
                                    ...
                                    @if (isset($homepage_info->newsletter_image))
                                        Old Background Image: &nbsp; <img src="{{ @$homepage_info->newsletter_image }}"
                                            alt="Image Not Available" class="img img-thumbail mt-2" style="width: 100px">
                                    @endif
                            ...
                            @for ($i = 1; $i < 4; $i++)
                                <div class="form-group row">
                                    ...
                                    {{ Form::text('newsletter_counters[' . $i . '][title]', @$homepage_info->newsletter_counters[$i]['title'], ['placeholder' => 'Enter Title ' . $i, 'class' => 'col-sm-3 form-control', 'id' => 'newsletter_counters[' . $i . '][title]', 'style' => 'width:80%']) }}
                                    {{ Form::label('newsletter_counters[' . $i . '][number]', 'Counter Number ' . $i . ' :', ['class' => 'ml-4 col-sm-2']) }}
                                    {{ Form::number('newsletter_counters[' . $i . '][number]', @$homepage_info->newsletter_counters[$i]['number'], ['placeholder' => 'Enter Number ' . $i, 'class' => 'col-sm-3 form-control', 'id' => 'newsletter_counters[' . $i . '][number]', 'style' => 'width:80%']) }}
                                </div>
                            @endfor
                    ...
                    <div class="tab-pane fade" id="custom-tabs-three-work" role="tabpanel"
                        ...
                        <div class="page-description-div">
                            ...
                            <div class="form-group row {{ $errors->has('work_title') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('work_title', @$homepage_info->work_title, ['placeholder' => 'Enter Title', 'class' => 'form-control', 'id' => 'work_title', 'style' => 'width:80%']) }}
                                    @error('work_title')
                                        <span class="help-block error">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row {{ $errors->has('work_subtitle') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('work_subtitle', @$homepage_info->work_subtitle, ['placeholder' => 'Enter Subtitle', 'class' => 'form-control', 'id' => 'work_subtitle', 'style' => 'width:80%']) }}
                                    @error('work_subtitle')
                                        <span class="help-block error">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            @for ($i = 1; $i < 4; $i++)
                                ...
                                <div class="form-group row">
                                    ...
                                    {{ Form::text('work_detail[' . $i . '][title]', @$homepage_info->work_detail[$i]['title'], ['placeholder' => 'Enter Title ' . $i, 'class' => 'col-sm-3 form-control', 'id' => 'work_detail[' . $i . '][title]', 'style' => 'width:80%']) }}
                                    {{ Form::label('work_detail[' . $i . '][subtitle]', 'Subtitle ' . $i . ' :', ['class' => 'ml-4 col-sm-2']) }}
                                    {{ Form::text('work_detail[' . $i . '][subtitle]', @$homepage_info->work_detail[$i]['subtitle'], ['placeholder' => 'Enter Subtitle ' . $i, 'class' => 'col-sm-3 form-control', 'id' => 'work_detail[' . $i . '][subtitle]', 'style' => 'width:80%']) }}
                                </div>
                                <div class="form-group row">
                                    {{ Form::label('work_detail[' . $i . '][description]', 'Description ' . $i . ' :', ['class' => 'col-sm-3']) }}
                                    {{ Form::textarea('work_detail[' . $i . '][description]', @$homepage_info->work_detail[$i]['description'], ['placeholder' => 'Enter Description ' . $i, 'class' => 'col-sm-6 form-control', 'id' => 'work_detail[' . $i . '][description]', 'style' => 'width:80%']) }}
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        @if (isset($homepage_info->work_detail[$i]['image']))
                                            Old Background Image: &nbsp; <img
                                                src="{{ @$homepage_info->work_detail[$i]['image'] }}"
                                ...
                                @for ($j = 1; $j < 4; $j++)
                                    <div class="form-group row">
                                        ...
                                        {{ Form::text('work_detail[' . $i . '][bullet][' . $j . '][title]', @$homepage_info->work_detail[$i]['bullet'][$j]['title'], ['placeholder' => 'Enter Bullet Title ' . $j, 'class' => 'col-sm-3 form-control', 'id' => 'work_detail[' . $i . '][bullet][' . $j . '][title]', 'style' => 'width:80%']) }}
                                        {{ Form::label('work_detail[' . $i . '][bullet][' . $j . '][subtitle]', 'Bullet Subtitle ' . $j . ' :', ['class' => 'ml-4 col-sm-2']) }}
                                        {{ Form::text('work_detail[' . $i . '][bullet][' . $j . '][subtitle]', @$homepage_info->work_detail[$i]['subtitle'], ['placeholder' => 'Enter Subtitle ' . $j, 'class' => 'col-sm-3 form-control', 'id' => 'work_detail[' . $i . '][bullet][' . $j . '][subtitle]', 'style' => 'width:80%']) }}
                                    </div>
                                @endfor
                            @endfor
                    ...
                    <div class="tab-pane fade" id="custom-tabs-three-priceplanteamreview" role="tabpanel"
                        ...
                        <div class="page-description-div">
                            ...
                            <div class="form-group row {{ $errors->has('priceplan_title') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('priceplan_title', @$homepage_info->priceplan_title, ['placeholder' => 'Enter Price Plan Title', 'class' => 'form-control', 'id' => 'priceplan_title', 'style' => 'width:80%']) }}
                            ...
                            <div class="form-group row {{ $errors->has('priceplan_subtitle') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('priceplan_subtitle', @$homepage_info->priceplan_subtitle, ['placeholder' => 'Enter Price Plan Subtitle', 'class' => 'form-control', 'id' => 'priceplan_subtitle', 'style' => 'width:80%']) }}
                            ...
                            <div class="form-group row {{ $errors->has('team_title') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('team_title', @$homepage_info->team_title, ['placeholder' => 'Enter Team Title', 'class' => 'form-control', 'id' => 'team_title', 'style' => 'width:80%']) }}
                                    @error('team_title')
                                        <span class="help-block error">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row {{ $errors->has('team_subtitle') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('team_subtitle', @$homepage_info->team_subtitle, ['placeholder' => 'Enter Team Subtitle', 'class' => 'form-control', 'id' => 'team_subtitle', 'style' => 'width:80%']) }}
                                    @error('team_subtitle')
                                        <span class="help-block error">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row {{ $errors->has('review_title') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('review_title', @$homepage_info->review_title, ['placeholder' => 'Enter Review Title', 'class' => 'form-control', 'id' => 'review_title', 'style' => 'width:80%']) }}
                                    @error('review_title')
                                        <span class="help-block error">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row {{ $errors->has('review_subtitle') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('review_subtitle', @$homepage_info->review_subtitle, ['placeholder' => 'Enter Review Subtitle', 'class' => 'form-control', 'id' => 'review_subtitle', 'style' => 'width:80%']) }}
                    ...
                    <div class="tab-pane fade" id="custom-tabs-three-faq" role="tabpanel"
                        ...
                        <div class="page-description-div">
                            ...
                            <div class="form-group row {{ $errors->has('faq_title') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('faq_title', @$homepage_info->faq_title, ['placeholder' => 'Enter FAQ Title', 'class' => 'form-control', 'id' => 'faq_title', 'style' => 'width:80%']) }}
                                    @error('faq_title')
                                        <span class="help-block error">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row {{ $errors->has('faq_subtitle') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('faq_subtitle', @$homepage_info->faq_subtitle, ['placeholder' => 'Enter FAQ Subtitle', 'class' => 'form-control', 'id' => 'faq_subtitle', 'style' => 'width:80%']) }}
                                    @error('faq_subtitle')
                                        <span class="help-block error">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row {{ $errors->has('faq_image') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <span class="input-group-btn">
                                            <a id="lfm10" data-input="faq_image" data-preview="holder"
                                                class="btn btn-primary text-white">
                                                <i class="fa fa-picture-o"></i> Choose
                                            </a>
                                        </span>
                                        <input id="faq_image" class="form-control" type="text"
                                            name="faq_image">
                                    </div>
                                    <div id="holder" style="
                                                    border: 1px solid #ddd;
                                    ...
                                    @if (isset($homepage_info->faq_image))
                                        Old Background Image: &nbsp; <img src="{{ @$homepage_info->faq_image }}"
                                            alt="Image Not Available" class="img img-thumbail mt-2" style="width: 100px">
                                    @endif
                                    @error('faq_image')
                                        <span class="help-block error">{{ $message }}</span>
                            ...
                            <div class="form-group row {{ $errors->has('faq_link') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('faq_link', @$homepage_info->faq_link, ['placeholder' => 'Enter FAQ Link', 'class' => 'form-control', 'id' => 'faq_link', 'style' => 'width:80%']) }}
                                    @error('faq_link')
                                        <span class="help-block error">{{ $message }}</span>
                                    @enderror
                                </div>
                    ...
                    <div class="tab-pane fade" id="custom-tabs-three-blog" role="tabpanel"
                        aria-labelledby="custom-tabs-three-blog-tab">
                        <div class="page-description-div">

                            <div class="form-group row {{ $errors->has('blog_title') ? 'has-error' : '' }}">
                                {{ Form::label('blog_title', 'Blog Title:', ['class' => 'col-sm-3']) }}
                                <div class="col-sm-9">
                                    {{ Form::text('blog_title', @$homepage_info->blog_title, ['placeholder' => 'Enter blog Title', 'class' => 'form-control', 'id' => 'blog_title', 'style' => 'width:80%']) }}
                                    @error('blog_title')
                                        <span class="help-block error">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row {{ $errors->has('blog_subtitle') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('blog_subtitle', @$homepage_info->blog_subtitle, ['placeholder' => 'Enter blog Subtitle', 'class' => 'form-control', 'id' => 'blog_subtitle', 'style' => 'width:80%']) }}
                                    @error('blog_subtitle')
                                        <span class="help-block error">{{ $message }}</span>
                                    @enderror
                                </div>
                    ...
                    <div class="tab-pane fade" id="custom-tabs-three-parallax" role="tabpanel"
                        aria-labelledby="custom-tabs-three-parallax-tab">
                        <div class="page-description-div">

                            <div class="form-group row {{ $errors->has('parallax_title') ? 'has-error' : '' }}">
                                {{ Form::label('parallax_title', 'Parallax Title:', ['class' => 'col-sm-3']) }}
                                <div class="col-sm-9">
                                    {{ Form::text('parallax_title', @$homepage_info->parallax_title, ['placeholder' => 'Enter Parallax Title', 'class' => 'form-control', 'id' => 'parallax_title', 'style' => 'width:80%']) }}
                            ...
                            <div class="form-group row {{ $errors->has('parallax_subtitle') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('parallax_subtitle', @$homepage_info->parallax_subtitle, ['placeholder' => 'Enter Parallax Subtitle', 'class' => 'form-control', 'id' => 'parallax_subtitle', 'style' => 'width:80%']) }}
                            ...
                            <div class="form-group row {{ $errors->has('parallax_image') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <span class="input-group-btn">
                                            <a id="lfm11" data-input="parallax_image" data-preview="holder"
                                                class="btn btn-primary text-white">
                                                <i class="fa fa-picture-o"></i> Choose
                                            </a>
                                        </span>
                                        <input id="parallax_image" class="form-control" type="text"
                                            name="parallax_image">
                                    </div>
                                    <div id="holder" style="
                                                    border: 1px solid #ddd;
                                    ...
                                    @if (isset($homepage_info->parallax_image))
                                        Old Background Image: &nbsp; <img src="{{ @$homepage_info->parallax_image }}"
                                            alt="Image Not Available" class="img img-thumbail mt-2" style="width: 100px">
                                    @endif
                    ...
                    <div class="tab-pane fade" id="custom-tabs-three-contact" role="tabpanel"
                        ...
                        <div class="page-description-div">
                            ...
                            <div class="form-group row {{ $errors->has('contact_title') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('contact_title', @$homepage_info->contact_title, ['placeholder' => 'Enter Contact Title', 'class' => 'form-control', 'id' => 'contact_title', 'style' => 'width:80%']) }}
                                    @error('contact_title')
                                        <span class="help-block error">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row {{ $errors->has('contact_subtitle') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('contact_subtitle', @$homepage_info->contact_subtitle, ['placeholder' => 'Enter Contact Subtitle', 'class' => 'form-control', 'id' => 'contact_subtitle', 'style' => 'width:80%']) }}
                            ...
                            <div class="form-group row {{ $errors->has('contact_form_title') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('contact_form_title', @$homepage_info->contact_form_title, ['placeholder' => 'Enter Contact Form Title', 'class' => 'form-control', 'id' => 'contact_form_title', 'style' => 'width:80%']) }}
                    ...
                    <div class="tab-pane fade" id="custom-tabs-three-mapfooter" role="tabpanel"
                        ...
                        <div class="page-description-div">
                            ...
                            <div class="form-group row {{ $errors->has('footer_contact_subtitle') ? 'has-error' : '' }}">
                                {{ Form::label('footer_contact_subtitle', 'Footer Contact Subtitle:', ['class' => 'col-sm-3']) }}
                                <div class="col-sm-9">
                                    {{ Form::text('footer_contact_subtitle', @$homepage_info->footer_contact_subtitle, ['placeholder' => 'Enter Footer Contact Subtitle', 'class' => 'form-control', 'id' => 'footer_contact_subtitle', 'style' => 'width:80%']) }}
                            ...
                            <div class="form-group row {{ $errors->has('footer_company_subtitle') ? 'has-error' : '' }}">
                                {{ Form::label('footer_company_subtitle', 'Footer Company Subtitle:', ['class' => 'col-sm-3']) }}
                                <div class="col-sm-9">
                                    {{ Form::text('footer_company_subtitle', @$homepage_info->footer_company_subtitle, ['placeholder' => 'Enter Contact Form Title', 'class' => 'form-control', 'id' => 'footer_company_subtitle', 'style' => 'width:80%']) }}
