                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 border-right">
                                    ...
                                    <p class="text-sm">Add Aditional Security to your account using two factor
                                        authentication.</p>
                                    <hr>
                                    <div class="m-b-20">
                                        @if (session('status') == 'two-factor-authentication-enabled' || auth()->user()->two_factor_recovery_codes)
                                            <p class="mb-4 font-strong">You have enabled 2FA, please scan the following QR
                                                code into
                                                your phones authenticator application.</p>
                                            <div class="d-flex justify-content-center">
                                                {!! auth()->user()->twoFactorQrCodeSvg() !!}
                                            </div>
                                            <p class="mt-4 font-strong">Please store these recovery code in secure place.
                                            </p>
                                            <div class="d-flex justify-content-center">
                                                @foreach
                                                (json_decode(decrypt(auth()->user()->two_factor_recovery_codes,true)) as
                                                $code)
                                                {{ trim($code) }} <br>
                                        @endforeach
                                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 border-right">
                                <h5 class="text-primary">Two Factor Authentication</h5>
                                <p class="text-sm">Add Aditional Security to your account using two factor authentication.
                                </p>
                                <hr>
                                <div class="m-b-20">
                                    @if (session('status') == 'two-factor-authentication-enabled' || auth()->user()->two_factor_recovery_codes)
                                        <p class="mb-4 font-strong">You have enabled 2FA, please scan the following QR code
                                            into
                                            your phones authenticator application.</p>
                                        <div class="d-flex justify-content-center">
                                            {!! auth()->user()->twoFactorQrCodeSvg() !!}
