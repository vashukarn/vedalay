// function ImageAssets(divId, imageView, inputName) {
...
function uploadImage(input) {
    ...
    var inputHiddenName = '#' + inputName + '_name';
    var imageView = '#' + imageId + '_view';
    this.inputName = inputName;
    this.imageId = imageId;
    this.imageView = imageView;
    this.inputHiddenName = inputHiddenName;
    // new ImageAssets(imageId, inputName, imageView);
    ...
    $.ajax({
        ...
        success: response => {
            ...
            if (response.status == true) {
                ...
                $(this.inputHiddenName).val(response.image);
