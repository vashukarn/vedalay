...
class TeacherController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $teacher->session = $request->session;
            $teacher->dob = $request->dob;
            $teacher->aadhar_number = $request->aadhar_number;
            $teacher->blood_group = $request->blood_group;
            $teacher->gender = $request->gender;
            $teacher->caste_category = $request->caste_category;
            $teacher->disability = $request->disability;
            $teacher->fathername = $request->fathername;
            $teacher->fatheroccupation = $request->fatheroccupation;
            $teacher->fatherincome = $request->fatherincome;
            $teacher->mothername = $request->mothername;
            $teacher->motheroccupation = $request->motheroccupation;
            $teacher->motherincome = $request->motherincome;
            $teacher->guardian_name = $request->guardian_name;
            $teacher->guardian_phone = $request->guardian_phone;
