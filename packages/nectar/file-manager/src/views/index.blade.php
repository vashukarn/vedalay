...
<head>
  ...
  <style>{!! \File::get(base_path('packages/nectar/file-manager/public/css/lfm.css')) !!}</style>
...
<body>
  ...
  <div class="d-flex flex-row">
    ...
    <div id="main">
      ...
      width: 50%;
      padding: 10px;" id="pagination"></div>
  ...
  <script>{!! \File::get(base_path('packages/nectar/file-manager/public/js/script.js')) !!}</script>
